...
> Een InformatieObject wordt dus qua vertaling/binding in W3C een nen2660:InformationObject en qua CSV: Tabel 'Documenten' en Kolom: 'Type' 
...
<figure>
<img src="./media/NEN-2660-UML-Schema-ContractueleEisen.png" alt="UML Schema van een deel van de NEN2660-2 voor toepassing op uitwisseling van contractuele eisen">
