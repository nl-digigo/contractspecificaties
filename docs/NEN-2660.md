...
* Voor [=JSON=]: [[json]]
* Voor [=Turtle=]: [[turtle]]
* Voor [=CSV=] is er geen formele specificatie, er bestaan meerdere interpretaties. Voor dit uitwisselformaat gebruiken we https://csv-spec.org/ ; bij W3C is gewerkt aan nog veel meer moois dat we nog niet toepassen: https://www.w3.org/TR/2016/NOTE-tabular-data-primer-20160225/
