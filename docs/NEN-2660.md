...
Dit document heeft al doel om met gebruikers een eenvoudige uitwisselmethode vast te stellen met tabellen, waarmee de meest gangbare applicaties voor eisenmanagement direct uit de voeten kunnen. Deze tabellen hebben een vertaling / binding naar het conceptuele model van NEN 2660 - Regels voor informatiemodellering van de gebouwde omgeving. Hiermee kunnen gebruikers die dit wensen een eisenset ook in linked data vorm beschikbaar stellen of uitwisselen. De tabellen kunnen ook gebruikt worden in een VISI raamwerk en als onderdeel van een VISI bericht.
