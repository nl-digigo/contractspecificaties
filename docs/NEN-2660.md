...
Dit document heeft als doel om met gebruikers een eenvoudige uitwisselmethode vast te stellen met tabellen, waarmee de meest gangbare applicaties voor eisenmanagement direct uit de voeten kunnen. Deze tabellen hebben een vertaling / binding naar linked data standaarden met behulp van een informatiemodel. Met dit model kunnen gebruikers die dit wensen een eisenset ook in LinkedData vorm beschikbaar stellen of uitwisselen, of contractspecificaties uitwisselen in andere open formaten zoals XML, GML, Geopackage of als onderdeel van een VISI bericht. 
