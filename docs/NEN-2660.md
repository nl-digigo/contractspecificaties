...
### LinkedData
Bij deze contractspecificaties is ook een informatiemodel beschikbaar in linked open data. Op basis hiervan kunnen contractspecificaties ook als linked data worden opgesteld. 
...
Het informatiemodel is ook in turte-formaat beschikbaar op Github. 
